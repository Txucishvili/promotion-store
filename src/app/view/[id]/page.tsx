        ...
        <div className="flex flex-wrap -mx-4">
            ...
            <ul className="flex flex-wrap items-center mb-4">
              <li className="mr-6">
                <a
                  ...
                  href="#"
                >
                  <span data-config-id="auto-txt-1-1">Home</span>
                  <svg
                    className="ml-6"
                    width={4}
                    height={7}
              ...
              <li className="mr-6">
                <a
                  ...
                  href="#"
                >
                  <span data-config-id="auto-txt-2-1">Store</span>
                  <svg
                    className="ml-6"
                    width={4}
                    height={7}
          ...
          <div className="w-full lg:w-1/2 px-4 lg:mb-0">
            <div className="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-start xl:items-center">
              ...
              <div className="w-full order-2 xl:order-1 sm:w-auto min-w-max px-4 text-center flex sm:flex-col items-center justify-center">
                <a
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="max-w-md mb-6">
              ...
              <h2
                className="mt-6 mb-4 text-5xl md:text-7xl lg:text-4xl font-heading font-medium"
              ...
              <p className="text-lg text-gray-400" data-config-id="auto-txt-16-1">
                The nulla commodo, commodo eros a lor, tristique lectus. Lorem sad 128
                GB silver.
              </p>
            </div>
